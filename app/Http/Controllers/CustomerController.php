...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($search_column) {
            $customers->where(function ($query) use ($search_column) {
                $query->where('phone', 'like', '%' . $search_column . '%')
                    ->orWhere('balance', $search_column)
                    ->orWhereHas('orders', function ($query) use ($search_column) {
        ...
        return view('backend.customers.index', compact('customers', 'sort_search', 'search_column'));
    }
