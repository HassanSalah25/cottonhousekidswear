...
class InvoiceController extends Controller
{
    ...
    {
        $currency_code = session()->get('currency_code', Currency::findOrFail(get_setting('system_default_currency'))->code);
        ...
        if ($currency_code == 'AED' || $currency_code == 'EGP' || $language_code == 'ar') {
            // Use a font that supports Arabic
            $font_family = "'Amiri', 'DejaVu Sans', 'sans-serif'";
        } else {
            // General font
