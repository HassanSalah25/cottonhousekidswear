        ...
        if($order){
            if(auth('api')->user()->id == $order->user_id){
                ...
                if($refund_request){
                    ...
                    $refund_request->reasons = $request->refund_reasons;
                ...
                if( $order->payment_status == 'paid' && in_array($order->delivery_status, $refund_request_order_status) &&  $today_date <= $last_refund_date){
