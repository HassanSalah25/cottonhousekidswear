...
class PasswordResetController extends Controller
{
    ...
    {
        return view('frontend.auth.layout.forget_password');
    }
...
//            Mail::to($user->email)->queue(new EmailManager($array));
            flash(translate('A password reset code has been sent to your email.'))->success();
    ...
    {
        return view('frontend.auth.layout.reset_password');
    }
