        ...
        return [
            'data' => $this->collection->map(function($data) {
                return [
                    ...
                    'base_price' => $data->product ? (double) product_base_price($data->product) : 0,
                    'base_discounted_price' => $data->product ? (double) product_discounted_base_price($data->product) : 0,
