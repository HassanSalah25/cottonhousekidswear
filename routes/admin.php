...
// Output example
    foreach ($apiRoutes as $route) {
        echo $route->uri() . ' - ' . implode(',', $route->methods()) . PHP_EOL;
    }
});
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('bulks/{bulkPurchase}', [BulkPurchaseController::class, 'destroy'])->name('bulks.destroy');
    Route::get('bulks/show/{bulkPurchase}', [BulkPurchaseController::class, 'show'])->name('bulks.show');
    Route::put('bulks/update/{bulkPurchase}', [BulkPurchaseController::class, 'update'])->name('bulks.update');
    Route::get('bulks', [BulkPurchaseController::class, 'index'])->name('bulks.index');
