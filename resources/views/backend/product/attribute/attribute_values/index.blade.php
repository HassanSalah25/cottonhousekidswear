						...
						@foreach($attribute_values as $key => $attribute_value)
							<tr>
								...
								<td class="text-right">
									...
									<a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('attribute_values.destroy', $attribute_value->id)}}" title="{{ translate('Delete') }}">
