...
@section('content')
    ...
    <div class="accordion" id="accordionExample">
        ...
        <div class="card border-bottom">
            <div class="card-header c-pointer" data-toggle="collapse" data-target="#collapseHomeSlider"
                 aria-expanded="true" aria-controls="collapseHomeSlider">
                    ...
                    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row gutters-10 border-bottom pb-4 mb-4">
                            <div class="col-lg-3">
                                ...
                                <small>{{ translate('RecomRmended size').' 640x310' }}</small>
                            </div>
                            <div class="col-lg-9">
                                <div class="home-slider-1-target">
                                    ...
                                    <input type="hidden" name="types[]" value="home_slider_1_content">
                                    @if (get_setting('home_slider_1_images') != null)
                                        @foreach (json_decode(get_setting('home_slider_1_images'), true) as $key => $value)
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        <div class="input-group" data-toggle="aizuploader"
                                                            ...
                                                            <input type="hidden" name="home_slider_1_images[]"
                                                ...
                                                <div class="col-lg">
                                                    <input type="text" placeholder="" name="home_slider_1_links[]"
                                                           value="{{ json_decode(get_setting('home_slider_1_links'),true)[$key] }}"
                                                           class="form-control">
                                                </div>
                                                <div class=" row">
                                                    <label class="from-label d-block">{{translate('Content')}}</label>
                                                    <textarea name="home_slider_1_content[]"
                                                              class="form-control aiz-text-editor ">{{ json_decode(get_setting('home_slider_1_content'),true)[$key] }}</textarea>
                                                </div>
                                                <div class="col-auto">
                                                    <button type="button"
                        ...
                        <div class="form-group row gutters-10  border-bottom pb-4 mb-4">
                            ...
                            <div class="col-lg-9">
                                <div class="home-slider-2-target">
                                    ...
                                    <input type="hidden" name="types[]" value="home_slider_2_content">
                                    @if (get_setting('home_slider_2_images') != null)
                                        @foreach (json_decode(get_setting('home_slider_2_images'), true) as $key => $value)
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        <div class="input-group" data-toggle="aizuploader"
                                                            ...
                                                            <div
                                                                class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                            <input type="hidden" name="home_slider_2_images[]"
                                                                   class="selected-files" value="{{ $value }}">
                                                        </div>
                                                        <div class="file-preview box sm"></div>
                                                    </div>
                                                ...
                                                <div class="col-lg">
                                                    <input type="text" placeholder="" name="home_slider_2_links[]"
                                                           value="{{ json_decode(get_setting('home_slider_2_links'),true)[$key] }}"
                                                           class="form-control">
                                                </div>
                                                <div class=" row">
                                                    <label class="from-label d-block">{{translate('Content')}}</label>
                                                    <textarea name="home_slider_2_content[]"
                                                              class="form-control aiz-text-editor ">{{ json_decode(get_setting('home_slider_2_content'),true)[$key] }}</textarea>
                                                </div>
                                                <div class="col-auto">
                                                    <button type="button"
                                                            class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger"
                                ...
                                <div class="text-right">
                                    <button
										...
										<div class=" row">
                                            <label class="from-label d-block">{{translate('Content')}}</label>
                                            <textarea name="home_slider_2_content[]" class="form-control aiz-text-editor "></textarea>
                                        </div>
										<div class="col-auto">
											<button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
												<i class="las la-times"></i>
                        ...
                        <div class="form-group row gutters-10 border-bottom pb-4 mb-4">
                            ...
                            <div class="col-lg-9">
                                <div class="home-slider-3-target">
                                    ...
                                    <input type="hidden" name="types[]" value="home_slider_3_content">
                                    @if (get_setting('home_slider_3_images') != null)
                                        @foreach (json_decode(get_setting('home_slider_3_images'), true) as $key => $value)
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        <div class="input-group" data-toggle="aizuploader"
                                                            ...
                                                            <div
                                                                class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                            <input type="hidden" name="home_slider_3_images[]"
                                                                   class="selected-files" value="{{ $value }}">
                                                        </div>
                                                        <div class="file-preview box sm"></div>
                                                    </div>
                                                ...
                                                <div class="col-lg">
                                                    <input type="text" placeholder="" name="home_slider_3_links[]"
                                                           value="{{ json_decode(get_setting('home_slider_3_links'),true)[$key] }}"
                                                           class="form-control">
                                                </div>
                                                <div class=" row">
                                                    <label class="from-label d-block">{{translate('Content')}}</label>
                                                    <textarea name="home_slider_3_content[]"
                                                              class="form-control aiz-text-editor ">{{ json_decode(get_setting('home_slider_3_content'),true)[$key] }}</textarea>
                                                </div>
                                                <div class="col-auto">
                                                    <button type="button"
                                                            class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger"
                                ...
                                <div class="text-right">
                                    <button
										...
										<div class=" row">
                                            <label class="from-label d-block">{{translate('Content')}}</label>
                                            <textarea name="home_slider_3_content[]" class="form-control aiz-text-editor "></textarea>
                                        </div>
										<div class="col-auto">
											<button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
												<i class="las la-times"></i>
                        ...
                        <div class="form-group row gutters-10">
                            ...
                            <div class="col-lg-9">
                                <div class="home-slider-4-target">
                                    ...
                                    <input type="hidden" name="types[]" value="home_slider_4_content">
                                    @if (get_setting('home_slider_4_images') != null)
                                        @foreach (json_decode(get_setting('home_slider_4_images'), true) as $key => $value)
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        <div class="input-group" data-toggle="aizuploader"
                                                            ...
                                                            <div
                                                                class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                            <input type="hidden" name="home_slider_4_images[]"
                                                                   class="selected-files" value="{{ $value }}">
                                                        </div>
                                                        <div class="file-preview box sm"></div>
                                                    </div>
                                                ...
                                                <div class="col-lg">
                                                    <input type="text" placeholder="" name="home_slider_4_links[]"
                                                           value="{{ json_decode(get_setting('home_slider_4_links'),true)[$key] }}"
                                                           class="form-control">
                                                </div>
                                                <div class=" row">
                                                    <label class="from-label d-block">{{translate('Content')}}</label>
                                                    <textarea name="home_slider_4_content[]"
                                                              class="form-control aiz-text-editor ">{{ json_decode(get_setting('home_slider_4_content'),true)[$key] }}</textarea>
                                                </div>
                                                <div class="col-auto">
                                                    <button type="button"
                                                            class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger"
                                ...
                                <div class="text-right">
                                    <button
										...
										<div class=" row">
                                            <label class="from-label d-block">{{translate('Content')}}</label>
                                            <textarea name="home_slider_4_content[]" class="form-control aiz-text-editor "></textarea>
                                        </div>
										<div class="col-auto">
											<button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
												<i class="las la-times"></i>
        ...
        <!-- Popular categories -->
        <div class="card border-bottom">
            <div class="card-header collapsed c-pointer" data-toggle="collapse" data-target="#collapsePopularCategories"
                 aria-expanded="true" aria-controls="collapsePopularCategories">
                    ...
                    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <select name="home_popular_categories[]" class="form-control aiz-selectpicker" multiple
                                        data-live-search="true" data-selected-text-format="count"
                                        data-selected="{{ get_setting('home_popular_categories') }}"
                                        data-container="body">
        ...
        <!-- Product section 1 -->
        <div class="card border-bottom">
            <div class="card-header collapsed c-pointer" data-toggle="collapse" data-target="#collapseProductSectionOne"
                 aria-expanded="true" aria-controls="collapseProductSectionOne">
                    ...
                    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text" placeholder="" name="home_product_section_1_title"
                                       value="{{ get_setting('home_product_section_1_title') }}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <select name="home_product_section_1_products[]" class="form-control aiz-selectpicker"
                                        multiple data-live-search="true" data-selected-text-format="count"
                                        data-selected="{{ get_setting('home_product_section_1_products') }}"
                                        data-container="body">
                                    @foreach ($all_products as $key => $product)
                                        <option
                                            value="{{ $product->id }}">{{ $product->getTranslation('name') }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
        ...
        <!-- Product section 2 -->
        <div class="card border-bottom">
            <div class="card-header collapsed c-pointer" data-toggle="collapse" data-target="#collapseProductSectionTwo"
                 aria-expanded="true" aria-controls="collapseProductSectionTwo">
                    ...
                    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text" placeholder="" name="home_product_section_2_title"
                                       value="{{ get_setting('home_product_section_2_title') }}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Select product')}}</label>
                            <div class="col-md-9">
                                ...
                                <select name="home_product_section_2_products[]" class="form-control aiz-selectpicker"
                                        multiple data-live-search="true" data-selected-text-format="count"
                                        data-selected="{{ get_setting('home_product_section_2_products') }}"
                                        data-container="body">
                                    @foreach ($all_products as $key => $product)
                                        <option
                                            value="{{ $product->id }}">{{ $product->getTranslation('name') }}</option>
        ...
        <!-- Hot Item -->
        <div class="card border-bottom">
            <div class="card-header collapsed c-pointer" data-toggle="collapse"
                 data-target="#collapseProductSectionThree" aria-expanded="true"
                 aria-controls="collapseProductSectionThree">
                <h6 class="my-2">{{ translate('Hot Item') }}</h6>
                <i class="las la-angle-down opacity-60 fs-20"></i>
            </div>
                    ...
                    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        {{--<div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text" placeholder="" name="home_product_section_3_title"
                                       value="{{ get_setting('home_product_section_3_title') }}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row gutters-10">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                        ...
                                        <input type="hidden" name="home_product_section_3_banner_img"
                                               class="selected-files"
                                               value="{{ get_setting('home_product_section_3_banner_img') }}">
                                    </div>
                                    <div class="file-preview box sm"></div>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                ...
                                <input type="text" placeholder="" name="home_product_section_3_banner_link"
                                       value="{{ get_setting('home_product_section_3_banner_link') }}"
                                       class="form-control">
                            </div>
                        </div>--}}
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <select name="home_product_section_3_products[]" class="form-control aiz-selectpicker"
                                        multiple data-live-search="true" data-selected-text-format="count"
                                        data-selected="{{ get_setting('home_product_section_3_products') }}"
                                        data-container="body">
                                    @foreach ($all_products as $key => $product)
                                        <option
                                            value="{{ $product->id }}">{{ $product->getTranslation('name') }}</option>
...
{{--
        <!-- Product section 4 -->
        <div class="card border-bottom">
            <div class="card-header collapsed c-pointer" data-toggle="collapse" data-target="#collapseProductSectionFour"
                 aria-expanded="true" aria-controls="collapseProductSectionFour">
                    ...
                    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text" placeholder="" name="home_product_section_4_title"
                                       value="{{ get_setting('home_product_section_4_title') }}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row gutters-10">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                        ...
                                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                        <input type="hidden" name="types[]" value="home_product_section_4_banner_img">
                                        <input type="hidden" name="home_product_section_4_banner_img"
                                               class="selected-files"
                                               value="{{ get_setting('home_product_section_4_banner_img') }}">
                                    </div>
                                    <div class="file-preview box sm"></div>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <input type="hidden" name="types[]" value="home_product_section_4_banner_link">
                                <input type="text" placeholder="" name="home_product_section_4_banner_link"
                                       value="{{ get_setting('home_product_section_4_banner_link') }}"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <select name="home_product_section_4_products[]" class="form-control aiz-selectpicker"
                                        multiple data-live-search="true" data-selected-text-format="count"
                                        data-selected="{{ get_setting('home_product_section_4_products') }}"
                                        data-container="body">
                                    @foreach ($all_products as $key => $product)
                                        <option
                                            value="{{ $product->id }}">{{ $product->getTranslation('name') }}</option>
        ...
        <div class="card border-bottom">
            <div class="card-header collapsed c-pointer" data-toggle="collapse" data-target="#collapseHomeBannerOne"
                 aria-expanded="true" aria-controls="collapseHomeBannerOne">
                        ...
                        <div class="form-group row gutters-10">
                            ...
                            <div class="col-lg-9">
                                <div class="home-banner-1-target">
                                    ...
                                    <input type="hidden" name="types[]" value="home_banner_1_contents">
                                    @if (get_setting('home_banner_1_images') != null)
                                        @foreach (json_decode(get_setting('home_banner_1_images'), true) as $key => $value)
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        <div class="input-group" data-toggle="aizuploader"
                                                            ...
                                                            <div
                                                                class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                            <input type="hidden" name="home_banner_1_images[]"
                                                                   class="selected-files" value="{{ $value }}">
                                                        </div>
                                                        <div class="file-preview box sm"></div>
                                                    </div>
                                                ...
                                                <div class="col-lg">
                                                    <input type="text" placeholder="" name="home_banner_1_links[]"
                                                           value="{{ json_decode(get_setting('home_banner_1_links'),true)[$key] }}"
                                                           class="form-control">
                                                </div>
                                                <div class=" row">
                                                    <label class="from-label d-block">{{translate('Content')}}</label>
                                                    <textarea name="home_banner_1_contents[]"
                                                              class="form-control aiz-text-editor ">{{ json_decode(get_setting('home_banner_1_contents'),true)[$key] }}</textarea>
                                                </div>
                                                <div class="col-auto">
                                                    <button type="button"
                                                            class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger"
        ...
        <div class="card border-bottom">
            <div class="card-header collapsed c-pointer" data-toggle="collapse" data-target="#collapseHomeBannerTwo"
                 aria-expanded="true" aria-controls="collapseHomeBannerTwo">
                                    ...
                                    @if (get_setting('home_banner_2_images') != null)
                                        @foreach (json_decode(get_setting('home_banner_2_images'), true) as $key => $value)
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        <div class="input-group" data-toggle="aizuploader"
                                                            ...
                                                            <div
                                                                class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                            <input type="hidden" name="home_banner_2_images[]"
                                                                   class="selected-files" value="{{ $value }}">
                                                        </div>
                                                        <div class="file-preview box sm"></div>
                                                    </div>
                                                ...
                                                <div class="col-lg">
                                                    <input type="text" placeholder="" name="home_banner_2_links[]"
                                                           value="{{ json_decode(get_setting('home_banner_2_links'),true)[$key] }}"
                                                           class="form-control">
                                                </div>
                                                <div class="col-auto">
                                                    <button type="button"
      ...
      {{--  <!-- Home banner section 3 -->
        <div class="card border-bottom">
            <div class="card-header collapsed c-pointer" data-toggle="collapse" data-target="#collapseHomeBannerThree"
                 aria-expanded="true" aria-controls="collapseHomeBannerThree">
                                    ...
                                    @if (get_setting('home_banner_3_images') != null)
                                        @foreach (json_decode(get_setting('home_banner_3_images'), true) as $key => $value)
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        <div class="input-group" data-toggle="aizuploader"
                                                            ...
                                                            <div
                                                                class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                            <input type="hidden" name="home_banner_3_images[]"
                                                                   class="selected-files" value="{{ $value }}">
                                                        </div>
                                                        <div class="file-preview box sm"></div>
                                                    </div>
                                                ...
                                                <div class="col-lg">
                                                    <input type="text" placeholder="" name="home_banner_3_links[]"
                                                           value="{{ json_decode(get_setting('home_banner_3_links'),true)[$key] }}"
                                                           class="form-control">
                                                </div>
                                                <div class="col-auto">
                                                    <button type="button"
        ...
        <div class="card border-bottom">
            <div class="card-header collapsed c-pointer" data-toggle="collapse" data-target="#collapseHomeBannerFour"
                 aria-expanded="true" aria-controls="collapseHomeBannerFour">
                                    ...
                                    @if (get_setting('home_banner_4_images') != null)
                                        @foreach (json_decode(get_setting('home_banner_4_images'), true) as $key => $value)
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="form-group">
                                                        <div class="input-group" data-toggle="aizuploader"
                                                            ...
                                                            <div
                                                                class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                            <input type="hidden" name="home_banner_4_images[]"
                                                                   class="selected-files" value="{{ $value }}">
                                                        </div>
                                                        <div class="file-preview box sm"></div>
                                                    </div>
                                                ...
                                                <div class="col-lg">
                                                    <input type="text" placeholder="" name="home_banner_4_links[]"
                                                           value="{{ json_decode(get_setting('home_banner_4_links'),true)[$key] }}"
                                                           class="form-control">
                                                </div>
                                                <div class="col-auto">
                                                    <button type="button"
        ...
        <!-- About  -->
        <div class="card border-bottom">
            <div class="card-header collapsed c-pointer" data-toggle="collapse" data-target="#homeAboutText"
                 aria-expanded="true" aria-controls="homeAboutText">
                ...
                <div class="card-body">
                    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="aiz-text-editor form-control" name="home_about_us" placeholder="Type.."
                                      data-min-height="350">
