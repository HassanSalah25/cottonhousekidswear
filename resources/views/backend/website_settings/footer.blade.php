                    ...
                    <div class="card shadow-none bg-light">
    					...
    					<div class="card-body">
                            <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
    							@csrf
                                <div class="form-group">
    								<label>{{ translate('First Contact address') }}</label>
                                ...
                                <div class="form-group">
                                    <label>{{ translate('Second Contact address') }}</label>
                                    <input type="hidden" name="types[]" value="contact_address_2">
                                    <input type="text" class="form-control" placeholder="{{ translate('Address') }} 2" name="contact_address_2" value="{{ get_setting('contact_address_2') }}">
                                </div>
                                <div class="form-group">
                ...
                <div class="card shadow-none bg-light">
					...
					<div class="card-body">
						<div class="form-group">
                            ...
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fa-brands fa-tiktok"></i>Tik tok</span>
                                </div>
                                <input type="text" class="form-control" placeholder="" name="footer_social_link[tiktok]" value="{{ $social_links['tiktok'] }}">
                            </div>
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="lab la-telegram"></i></span>
                                </div>
                                <input type="text" class="form-control" placeholder="" name="footer_social_link[telegram]" value="{{ $social_links['telegram'] }}">
                            </div>
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="lab la-whatsapp"></i></span>
                                </div>
                                <input type="text" class="form-control" placeholder="" name="footer_social_link[whatsapp]" value="{{ $social_links['whatsapp'] }}">
                            </div>
						</div>
					</div>
                </div>
