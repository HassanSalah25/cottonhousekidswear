                ...
                @if (addon_is_activated('multi_vendor') && (auth()->user()->can('show_orders') || auth()->user()->can('show_seller_orders')) )
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @can('show_bulks')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('bulks.index') }}"
                                       class="aiz-side-nav-link {{ areActiveRoutes(['bulks.index', 'bulks.show']) }}">
                ...
                @can('show_contacts')
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('contacts.index') }}"
                           class="aiz-side-nav-link {{ areActiveRoutes(['contacts.index', 'contacts.show']) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14">
                                <g id="Group_8860" data-name="Group 8860" transform="translate(30 -252)">
                                    <path id="Rectangle_16218" data-name="Rectangle 16218"
                                          d="M4,0H6a4,4,0,0,1,4,4V7a0,0,0,0,1,0,0H1A1,1,0,0,1,0,6V4A4,4,0,0,1,4,0Z"
                    ...
                    @canany(['show_sellers','show_payouts','show_payout_requests','show_commission_log','show_seller_packages','show_seller_package_payments'])
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                @can('show_payouts')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('admin.seller_payments_history') }}"
                                ...
                                @can('show_seller_package_payments')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('admin.package_purchase_history') }}"
                                           class="aiz-side-nav-link ">
                           ...
                           class="aiz-side-nav-link {{ areActiveRoutes(['querries.index', 'querries.show']) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16.499" height="15.527"
                                ...
                                <g id="Group_23439" data-name="Group 23439" transform="translate(12740.499 6159.76)">
                                    ...
                                    <rect id="Rectangle_17258" data-name="Rectangle 17258" width="2.48" height="2.875"
                                          transform="translate(-12734.919 -6156.351)" fill="#707070"/>
