...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 ">{{ translate('Paytabs Credential') }}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" onchange="updateSettings(this, 'paytabs_payment')"
                                           @if (get_setting('paytabs_payment') == 1) checked @endif>
                                    <span class="slider round"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYTABS_PROFILE_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('paytabs profile Id') }}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYTABS_PROFILE_ID"
                                       value="{{ env('PAYTABS_PROFILE_ID') }}"
                                       placeholder="{{ translate('paytabs Profile ID') }}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYTABS_SERVER_KEY_ID">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('paytabs server key id') }}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYTABS_SERVER_KEY_ID"
                                       value="{{ env('PAYTABS_SERVER_KEY_ID') }}"
                                       placeholder="{{ translate('paytabs server key id') }}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYTABS_CURRENCY">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('paytabs currency') }}</label>
                            </div>

                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYTABS_CURRENCY"
                                       value="{{ env('PAYTABS_CURRENCY') }}"
                                       placeholder="{{ translate('paytabs currency') }}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYTABS_REGION">
                            <div class="col-md-4">
                                <label class="col-from-label">{{ translate('paytabs region') }}</label>
                            </div>

                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYTABS_REGION"
                                       value="{{ env('PAYTABS_REGION') }}"
                                       placeholder="{{ translate('paytabs region') }}" required>
                            </div>
                        </div>
