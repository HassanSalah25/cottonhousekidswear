                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control aiz-selectpicker" name="system_default_currency"
                                        data-live-search="true" data-selected="{{ get_setting('system_default_currency') }}">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('settings.update') }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control aiz-selectpicker" name="symbol_format"
                                        data-selected="{{ get_setting('symbol_format') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control aiz-selectpicker" name="decimal_separator"
                                        data-selected="{{ get_setting('decimal_separator') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control aiz-selectpicker" name="no_of_decimals"
                                        data-selected="{{ get_setting('no_of_decimals') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    <label class="control-label">{{ translate('Shorten Large Price') }}</label>
                                </div>
                                <div class="col-lg-6">
                                    <select class="form-control aiz-selectpicker" name="truncate_price"
                                        data-selected="{{ get_setting('truncate_price') }}">
                                        <option value="0">Inactive [1000000]</option>
                                        <option value="1">Active [1M]</option>
                                    </select>
                                </div>
                            </div>
