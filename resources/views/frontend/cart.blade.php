    ...
    <div class="container-fluid">
        <div class="row m-5">
            ...
            <div class="row col-12">
                ...
                <div class="col-md-3"
                >
                    <a href="#" class="btn btn-light text-light rounded" data-target="#address_modal"
                       data-toggle="modal">{{translate('Change Address')}}</a>
                </div>
            </div>
        </div>
                            ...
                            <div class="row my-2">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <a href="{{route('cart.destroy',$cart_item)}}"
                                       class="btn btn-sm  text-uppercase btn-light"><i class="fa fa-trash pr-2"></i>{{translate('REMOVE
                                ITEM')}}
                                    </a>
                                    &nbsp;
                                    ...
                                    @auth
                                        @if(in_array($cart_item->product->id,auth()->user()?->wishlists()->pluck('product_id')->toArray()))
                                            <a title="Wishlist"
                                               ...
                                               class="btn btn-sm  text-uppercase btn-light"
                                               style="color: #ec1a25"
                    ...
                    <div class="card p-3" id="card-cost">
                        ...
                        <div class="form row">
                            <div class="col-sm-12">
                                ...
                                <input type="text" name="coupon_codes" class="form-control border-0 pl-2" placeholder="x x x x x x">
                                <hr class="mt-0">
                            </div>
                        </div>
        ...
        <div id="address_modal" class="modal fade" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-dialog-zoom" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal m-5" action="{{route('addresses.store')}}" method="POST"
