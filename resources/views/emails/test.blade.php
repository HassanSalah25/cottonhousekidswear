            ...
            <tr>
                <td>
                    <table>
                        ...
                        <tr>
                            <td style="">{{ translate('company_name') }} </td>
                        </tr>
                        <tr>
                            <td class="">{{ get_setting('invoice_address') }}</td>
                        </tr>
                        <tr>
                            <td class="">{{ translate('vat_registration_number') }}:
                                {{ get_setting('vat_registration_number') }}
                            </td>
                        </tr>
                        <tr>
                            <td class="">{{ translate('Email') }}:
                                {{ get_setting('invoice_email') }}
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table class="text-right">
                        ...
                        <tr>
                            <td class="">
                                ...
                                <a href="https://shaha.com.sa/admin/orders/{{ $order->id }}" target="_blank">
                                    <span class="bold" style="color: #ED2939">
                                        {{ $order->code }}
                                    </span>
                                </a>
                            </td>
                        ...
                        <tr>
                            <td>
                                ...
                                <span class="bold"
                                      style="text-transform: capitalize">{{ translate($order->first()->delivery_type) }}
                                </span>
                            </td>
                        </tr>
                        </tbody>
                        ...
                        <td style="border-bottom:1px solid #DEDEDE;">
                            ...
                            @if ($orderDetail->variation && $orderDetail->variation->combinations->count() > 0)
                                <span style="margin-right:10px">
                                    <span class="">{{ translate('SKU') }}</span>:
                                    <span>{{ $orderDetail->variation->sku }}</span>
                                </span>
